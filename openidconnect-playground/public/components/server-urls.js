...
class ServerURLs extends React.Component{
  ...
  componentDidMount(){
    document.querySelector('option[value=' + (this.props.server || 'IDCS' )+ ']').setAttribute('selected', 'true')
  ...
  render() {
    return (
      <div className="form-horizontal">
        ...
        <div className="form-horizontal">
          <div className="form-group">
            <div style={{display: this.props.server == 'IDCS' ? 'block': 'none'}}>
              <label htmlFor="domain" className="col-md-3 col-xs-12 control-label">IDCS domain</label>
              <div className="col-md-9 col-xs-12">
                <button
                  onClick={this.updateDiscovery}
                  className="btn btn-transparent btn-md button-float-right"
                >
                  Use IDCS Discovery Document
                </button>
                <div style={ { overflow: 'hidden' } }>
                  <input className="form-control input-with-button" name="domain" onChange={this.update} ref="domain" value={this.props.domain} placeholder="mydomain.identity.oraclecloud.com" />
                </div>
              </div>
            </div>
            <div style={{display: this.props.server != 'IDCS' ? 'block': 'none'}}>
          ...
          <div className="form-group">
            ...
            <div className="col-md-9 col-xs-12">
              <input className="form-control" name="authEndpoint" onChange={this.update} disabled={this.props.server != 'custom' ? 'disabled' : ''} value={this.props.authEndpoint} ref="authEndpoint" placeholder="https://idcs-b51dcb557a8049109dcdb8ebe2d08cd7.identity.oraclecloud.com/oauth2/v1/authorize" />
            </div>
          </div>
          ...
          <div className="form-group">
            ...
            <div className="col-md-9 col-xs-12">
              <input className="form-control" name="tokenEndpoint" onChange={this.update} disabled={this.props.server != 'custom' ? 'disabled' : ''} value={this.props.tokenEndpoint} ref="tokenEndpoint" placeholder="https://idcs-b51dcb557a8049109dcdb8ebe2d08cd7.identity.oraclecloud.com/oauth2/v1/token" />
            </div>
          </div>
          ...
          <div className="form-group" style={{ display: (this.props.tokenKeysEndpoint || this.props.server == 'custom') ? 'block': 'none' }}>
            ...
            <div className="col-md-9 col-xs-12">
              <input className="form-control" name="tokenEndpoint" onChange={this.update} disabled={this.props.server != 'custom' ? 'disabled' : ''} value={this.props.tokenKeysEndpoint} ref="tokenEndpoint" placeholder="https://idcs-b51dcb557a8049109dcdb8ebe2d08cd7.identity.oraclecloud.com/admin/v1/SigningCert/jwk" />
            </div>
          </div>
        </div>

        <p id="warning" style={{display:((this.props.server != 'IDCS' || (this.props.server == 'IDCS' && this.props.domain != 'idcs-b51dcb557a8049109dcdb8ebe2d08cd7.identity.oraclecloud.com')) ? 'block' : 'none')}}>Remember to set https://idcs-b51dcb557a8049109dcdb8ebe2d08cd7.identity.oraclecloud.com/oauth2/v1/social/callback as an allowed callback with your application!</p>
