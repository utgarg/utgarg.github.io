...
class InputPanel extends React.Component {
  ...
  updateServerURL(type, URL){
    ...
    if(type == 'IDCS'){
      this.refs.serverURL.updateLabel("Your IDCS Domain", "https://domain.identity.oraclecloud.com");
      this.setState({
        serverURL: changed ? 'https://idcs-b51dcb557a8049109dcdb8ebe2d08cd7.identity.oraclecloud.com' : (URL || 'https://'),
        ...
        warning: !this.state.clientID || this.state.clientID == '2f3c34d80b824b7b957b43cca2631b0d' ? false : true
      })
    } else if(type == 'custom'){
