...
class DebuggerPage extends React.Component {
  constructor() {
    ...
    this.state.server = this.state.server || 'IDCS';
    this.state.domain = this.state.domain || 'idcs-b51dcb557a8049109dcdb8ebe2d08cd7.identity.oraclecloud.com';
    this.state.authEndpoint = this.state.authEndpoint || 'https://idcs-b51dcb557a8049109dcdb8ebe2d08cd7.identity.oraclecloud.com/oauth2/v1/authorize';
    this.state.tokenEndpoint = this.state.tokenEndpoint || 'https://idcs-b51dcb557a8049109dcdb8ebe2d08cd7.identity.oraclecloud.com/oauth2/v1/token';
    this.state.tokenKeysEndpoint = this.state.tokenKeysEndpoint || '';
    this.state.userInfoEndpoint = this.state.userInfoEndpoint || 'https://idcs-b51dcb557a8049109dcdb8ebe2d08cd7.identity.oraclecloud.com/oauth2/v1/userinfo';
